...
namespace InteractionSystem {
    ...
    // public class InteractionPointVRVisual : MonoBehaviour {

        // [System.NonSerialized] static Material _interactionShowMaterial;
        // static Material interactionShowMaterial {
        //     get {
        //         if (_interactionShowMaterial == null) {
        //             _interactionShowMaterial = new Material(Shader.Find("Mobile/Particles/Additive"));
        //             _interactionShowMaterial.hideFlags = HideFlags.HideAndDontSave;
        //         }
        //         return _interactionShowMaterial;
        //     }
        // }
        ...
        //     interactRay.sharedMaterial = interactionShowMaterial;
        // }
        ...
        // }
        // void OnEnable () {
        //     InteractionPoint ip = GetComponent<InteractionPoint>();

        //     ip.onRayCheckUpdate += OnInteractionRayUpdate;
        ...
        // void OnInteractionRayUpdate (bool rayEnabled, Vector3 origin, Vector3 end, bool isHitting) {
        //      if (rayEnabled) {

                    
        //         VisualizeInteractionRay (origin, end, isHitting);
        //     }
        //     else {
...
//                     onRayCheckUpdate(rayEnabled, referenceTransform.position, hitPos, closestInteractable != null);
//                 }
...
//         public System.Action<bool, Vector3, Vector3, bool> onRayCheckUpdate;
