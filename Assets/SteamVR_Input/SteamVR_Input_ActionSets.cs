...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VRControlActionSet p_VRControlActionSet;
        ...
        public static SteamVR_Input_ActionSet_VRControlActionSet VRControlActionSet
        {
            get
            {
                return SteamVR_Actions.p_VRControlActionSet.GetCopy<SteamVR_Input_ActionSet_VRControlActionSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VRControlActionSet = ((SteamVR_Input_ActionSet_VRControlActionSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VRControlActionSet>("/actions/VRControlActionSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VRControlActionSet};
        }
    }
}
