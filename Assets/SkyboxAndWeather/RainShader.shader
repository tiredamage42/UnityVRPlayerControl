...
Shader "Custom Environment/Rain" {
	...
	Properties{
        ...
        [Enum(UnityEngine.Rendering.BlendMode)] _DstBlend ("BlendDestination", int) = 0//(int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha
        // [Enum(UnityEngine.Rendering.CullMode)] _Cull ("Cull", Float) = 0
        [Toggle] _UseBottomQuad ("Use Bottom Quad", Float) = 0
    ...
    SubShader{
        ...
        Pass {
            ...
            #include "RainShaderInclude.cginc"
