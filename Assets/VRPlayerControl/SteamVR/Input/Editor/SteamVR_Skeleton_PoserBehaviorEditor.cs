...
namespace VRPlayer// Valve.VR
{
    ...
    [CustomEditor(typeof(SteamVR_Skeleton_PoserBehavior))]
    public class SteamVR_Skeleton_PoserBehaviorEditor : Editor
    {
        ...
        private SteamVR_Skeleton_PoserBehavior poserBehavior;
        ...
        void DrawBlendingBehaviourMenu()
        {
            GUILayout.BeginVertical("box");
                ...
                blendPoseIndex = EditorGUILayout.Popup ("BlendedPose:", blendPoseIndex, blendNames);
                    ...
                    if (blenderType.intValue == (int)SteamVR_Skeleton_PoserBehavior.PoseBlendingBehaviour.BlenderTypes.AnalogAction)
                    {
                    ...
                    if (blenderType.intValue == (int)SteamVR_Skeleton_PoserBehavior.PoseBlendingBehaviour.BlenderTypes.BooleanAction)
                    {
                        EditorGUI.indentLevel++;
