...
/* 
    a custom Input Module

    same as the standard unity one, except it uses GetInput() method
    instead of the static unity Input class, to make sure we use any
    overrden input methods....
*/
namespace SimpleUI
{
  ...
  public abstract class PointerInputModule : BaseInputModule
  {
        ...
        public BaseInput GetInput () {
            return inputOverride != null ? inputOverride : input;
        }
