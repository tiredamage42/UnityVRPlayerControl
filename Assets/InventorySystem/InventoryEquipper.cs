    ...
    */
    ...
    public class InventoryEquipper : MonoBehaviour
    {
        ...
        public class EquipInfo
        {
            ...
            public EquipInfo( SceneItem sceneItem ) {
            ...
            public void ReturnItemToOriginalStateBeforeEquip (SceneItem sceneItem) {
        ...
        public event System.Action<Inventory, SceneItem, int, bool> onUnequip, onEquip, onEquipUpdate;
        ...
        [System.Serializable] public class EquipSlot {
            public EquipSlot(SceneItem sceneItem, EquipInfo equipInfo, bool isQuickEquipped) {
                this.sceneItem = sceneItem;
                this.equipInfo = equipInfo;
                this.isQuickEquipped = isQuickEquipped;
            }
            [HideInInspector] public SceneItem sceneItem;
        ...
        public bool ItemIsEquipped (int slotIndex, SceneItem item) {
            return ItemIsEquipped(slotIndex, item.itemBehavior);
        }

        EquipSlot BuildEquippedInventorySlot (SceneItem sceneItem, bool quickEquip) {
            return new EquipSlot (sceneItem, new EquipInfo( sceneItem ), quickEquip);
        }

        // equip from item behavior
        public void EquipItem (ItemBehavior itemBehavior, int equipSlot, SceneItem sceneItem) {
            ...
            if (sceneItem != null) {                
                ...
                if (equippedInventorySlot == null) {
                    equippedInventorySlot = BuildEquippedInventorySlot (SceneItem.GetSceneItem(itemBehavior), false);
                }
                else {
                    equippedSlots[oldIndex] = null;
                }
        ...
        public void UnequipItem(SceneItem item, bool showScene) {
            for (int i =0 ; i < equippedSlots.Length; i++) {
                if (equippedSlots[i] != null) {
