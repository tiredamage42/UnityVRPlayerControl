...
// ---- Screen space direction light shadows helpers (any version)
        ...
        #define TRANSFER_SHADOW(a, vertexWorld) a._ShadowCoord = mul( unity_WorldToShadow[0], vertexWorld );
        ...
        #define TRANSFER_SHADOW(a, vertexWorld) a._ShadowCoord = ComputeScreenPos(a.pos);
        inline fixed unitySampleShadow (unityShadowCoord4 shadowCoord)
        {
...
#define TRANSFER_SHADOW(a, vertexWorld) a._ShadowCoord.xyz = vertexWorld - _LightPositionRange.xyz;
...
#define TRANSFER_SHADOW(a, vertexWorld)
...
#   define COMPUTE_LIGHT_COORDS(a, vertexWorld) a._LightCoord = mul(unity_WorldToLight, vertexWorld).xyz;

#   define LIGHT_ATTENUATION(a) (tex2D(_LightTexture0, dot(a._LightCoord,a._LightCoord).rr).r * SHADOW_ATTENUATION(a))
// #   define LIGHT_ATTENUATION(a) (1 * SHADOW_ATTENUATION(a))
#endif
...
#   define COMPUTE_LIGHT_COORDS(a, vertexWorld) a._LightCoord = mul(unity_WorldToLight, vertexWorld);
...
#   define COMPUTE_LIGHT_COORDS(a, vertexWorld)
...
#   define COMPUTE_LIGHT_COORDS(a, vertexWorld) a._LightCoord = mul(unity_WorldToLight, vertexWorld).xy;
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a, vertexWorld) COMPUTE_LIGHT_COORDS(a, vertexWorld) TRANSFER_SHADOW(a, vertexWorld)
