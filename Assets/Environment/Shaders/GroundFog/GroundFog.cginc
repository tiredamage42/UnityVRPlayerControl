...
void DrawQuad (fixed2x2 rotationMatrix, fixed3 up, inout g2f OUT, inout TriangleStream<g2f> stream, fixed3 base, fixed3 top, fixed3 perpDir, fixed hueVariation, fixed distFade, fixed3 diffuseLighting, fixed3 ambientLighting) {
...
{    
    ...
    DrawQuad (rotationMatrix, groundNorm, OUT, stream, vertex, top, fixed3(.5 * width, 0, 0), hueVariation, distFade, diffuseLighting, ambientLighting);
